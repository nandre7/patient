...
class ThingsControllerTest < ActionController::TestCase
  ...
  test "should create thing" do
    assert_difference('Thing.count') do
      post :create, thing: { created_at: @thing.created_at, name: @thing.name, updated_at: @thing.updated_at }
    end
  ...
  test "should update thing" do
    patch :update, id: @thing, thing: { created_at: @thing.created_at, name: @thing.name, updated_at: @thing.updated_at }
    assert_redirected_to thing_path(assigns(:thing))
  end
