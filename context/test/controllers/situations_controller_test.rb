...
class SituationsControllerTest < ActionController::TestCase
  ...
  test "should create situation" do
    assert_difference('Situation.count') do
      post :create, situation: { created_at: @situation.created_at, text: @situation.text, updated_at: @situation.updated_at }
    end
  ...
  test "should update situation" do
    patch :update, id: @situation, situation: { created_at: @situation.created_at, text: @situation.text, updated_at: @situation.updated_at }
    assert_redirected_to situation_path(assigns(:situation))
  end
